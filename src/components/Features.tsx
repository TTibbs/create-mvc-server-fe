...
const Features = () => {
  const features = [
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M4 7v10c0 2 1 3 3 3h10c2 0 3-1 3-3V7c0-2-1-3-3-3H7c-2 0-3 1-3 3z M9 3v4 M15 3v4 M9 17v4 M15 17v4"
          />
        </svg>
      ),
    },
    ...
    },
    {
      ...
      description:
        "Option to initialize a Git repository automatically during project creation.",
      link: "#git",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    {
      title: "Directory Conflict Resolution",
      description:
        "Smart handling of existing directories with options to overwrite, merge, or cancel.",
      link: "#conflicts",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
